...
#ifdef ATOMIC64_INIT
#define __acc_add_atomic(a,v)	atomic64_add(a,v)
#define __acc_inc_atomic(v)	atomic64_inc(v)
#define __acc_dec_atomic(v)	atomic64_dec(v)
#else  /* !ATOMIC64_INIT */
#define __acc_add_atomic(a,v)	atomic_add(a,v)
#define __acc_inc_atomic(v)	atomic_inc(v)
#define __acc_dec_atomic(v)	atomic_dec(v)
#endif /* !ATOMIC64_INIT */
