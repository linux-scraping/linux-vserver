...
#define XFS_DIFLAG2_BARRIER_BIT	0	/* chroot() barrier */
#define XFS_DIFLAG2_IUNLINK_BIT	1	/* immutable unlink */

#define XFS_DIFLAG2_BARRIER	 (1 << XFS_DIFLAG2_BARRIER_BIT)
#define XFS_DIFLAG2_IUNLINK	 (1 << XFS_DIFLAG2_IUNLINK_BIT)

#define XFS_DIFLAG2_ANY \
	(XFS_DIFLAG2_BARRIER | XFS_DIFLAG2_IUNLINK)
